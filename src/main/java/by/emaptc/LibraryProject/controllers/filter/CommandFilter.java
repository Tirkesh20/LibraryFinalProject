package by.emaptc.LibraryProject.controllers.filter;

import by.emaptc.LibraryProject.controllers.command.CommandType;
...
import static by.emaptc.LibraryProject.controllers.command.Command.USER_ATTRIBUTE;
...
public class CommandFilter implements Filter {
    ...
    private final EnumSet<CommandType> clientCommand = EnumSet.range(CommandType.COMMON_ISSUE,CommandType.COMMON_RETURN_ISSUE);
